...
In this version of game, the groups are made up of 3.
...
Label(root,
      font='none 16 bold',
      textvariable = player_label_data).pack()
...
def btn_1_click():
    """ Run bottom 1 logic while cklicked """
    move = 1
    Players_turn()
    Game(move,player)
    return move,player
...
def btn_2_click():
    """ Run bottom 2 logic while cklicked """
    move = 2
    Players_turn()
    Game(move, player)
    return move, player
...
def btn_3_click():
    """ Run bottom 3 logic while cklicked """
    move = 3
    Players_turn()
    Game(move, player)
    return move, player
